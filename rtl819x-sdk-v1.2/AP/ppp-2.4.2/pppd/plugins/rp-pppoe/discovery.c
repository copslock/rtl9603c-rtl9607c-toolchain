...
"$Id: discovery.c,v 1.10 2010/03/10 05:30:09 keith_huang Exp $";
...
extern int wan_type_curr; //mark_test
...
discovery(PPPoEConnection *conn)
{
	...
	system("exlog /tmp/log_web.lck /tmp/log_web \"tag:SYSACT;log_num:13;msg:WAN Dialup;note:Try to establish PPPoE line;\"");
#endif	
...
#ifdef CONFIG_RTL8186_KB 
	system("blog WAN : PADO received");
#endif	
#if defined(CONFIG_RTL8186_TR) || defined(CONFIG_RTL865X_SC) || defined(CONFIG_RTL865X_AC) || defined(CONFIG_RTL865X_KLD) || defined(CONFIG_RTL8196C_EC)
	system("echo PADO > /tmp/pppcheck");
#endif	
