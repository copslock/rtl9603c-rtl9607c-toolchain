...
"$Id: plugin.c,v 1.10 2010/03/10 05:30:09 keith_huang Exp $";
...
#if defined(CONFIG_RTL8186_TR) || defined(CONFIG_RTL865X_SC) || defined(CONFIG_RTL865X_AC) || defined(CONFIG_RTL865X_KLD) || defined(CONFIG_RTL8196C_EC)
if(Idle_Event ==1){
system("exlog /tmp/log_web.lck /tmp/log_web \"tag:SYSACT;log_num:13;msg:PPPoE Idle Timeout!!;note:Disconnect PPPoE line;\"");
Idle_Event = 0;
}
else
system("exlog /tmp/log_web.lck /tmp/log_web \"tag:SYSACT;log_num:13;msg:Manual Hangup;note:Disconnect PPPoE line;\"");
#endif    
}
...
void
rtl_rp_fatal(char const *str) //mark_test
{
    char buf[1024];
    printErr(str);
    sprintf(buf, "RP-PPPoE: %.256s", str);
