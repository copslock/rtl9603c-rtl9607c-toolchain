 ...
 *
 *      $Id: apmib.h,v 1.68.2.10 2011/05/09 10:42:49 keith_huang Exp $
 *
 */
...
#define MIB_HW_11N_TRSWITCH 521 //MIB_HW_11N_RESERVED1 > MIB_HW_11N_TRSWITCH
...
#define MIB_HW_TX_POWER_5G_HT40_2S 912
#define MIB_HW_TX_POWER_5G_HT20 913
#define MIB_HW_TX_POWER_5G_DIFF_OFDM 914

/*new add end*/

#define MIB_VPN_PASSTHRU_IPV6	930

#define MIB_DHCP_LEASE_TIME	940
...
#define MAX_SUPER_NAME_LEN MAX_NAME_LEN-4
...
#define IFNAMSIZE       16
#define MAX_IFACE_VLAN_CONFIG 11 /* no wds and vxd*/
...
typedef struct vlan_lanconfig_entry {
	...
	unsigned char forwarding __PACK__; // related wan port 0:disable 1:bridge 2:nat
...
typedef struct hw_wlan_setting {
	...
	unsigned char trswitch __PACK__; // Reserved1 > trswitch
...
typedef struct config_setting {
	...
	unsigned char superName[MAX_SUPER_NAME_LEN] __PACK__ ; // supervisor name; reserved 4 bytes to dhcpLeaseTime
	unsigned int 	dhcpLeaseTime __PACK__;
