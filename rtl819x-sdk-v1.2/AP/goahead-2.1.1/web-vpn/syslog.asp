...
<body>
  ...
  <tr><td width="40%">&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="syslogEnabled" <%log=getIndex("logEnabled"); log=log>>1; log=log&1; if (log == 1) write("checked");%> value="ON" onClick="updateStateSys()"> <font size=2><b> system all </b></font><br></td> 
      <td width="60%"><input type="checkbox" name="wlanlogEnabled" <%log=getIndex("logEnabled"); log=log>>2; log=log&1; if (log == 1) write("checked"); %> value="ON" ><font size=2><b> wireless
      &nbsp;&nbsp;&nbsp;<input type="checkbox" name="doslogEnabled"  <%log=getIndex("logEnabled"); log=log>>3; log=log&1; if (log == 1) write("checked"); %> value="ON" >DoS</b></font><br></td>
  </tr>
