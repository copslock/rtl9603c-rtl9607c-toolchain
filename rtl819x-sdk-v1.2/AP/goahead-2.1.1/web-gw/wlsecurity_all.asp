...
-->				
                ...
                <td colspan="2">
                        <table width="100%" border="0" cellpadding="0" cellspacing="4">    
                                <tr>
                                        <td width="30%" class="bgblue"><font size="2"><b>Authentication Mode:</b></font></td>
                                        <td width="70%" class="bggrey"><font size="2">
                                                <input name="wapiAuth<% write(getIndex("wlan_idx")); %>" type="radio" value="eap" onClick="show_wapi_settings()">Enterprise (AS Server)
	...
	<tr id="show_8021x_eap" style="display:none">
        ...
        <tr id="show_8021x_wapi" style="display:none">
				...
				<tr>
                                         <td width="30%" bgcolor="#FFFFFF" class="bgblue"><font size="2"><b>AS&nbsp;Server&nbsp;IP&nbsp;Address:</b></font></td>
                                         <td width="70%" bgcolor="#FFFFFF" class="bggrey"><input id="wapiAS_ip" name="wapiASIP<% write(getIndex("wlan_idx")); %>" size="16" maxlength="15" value="0.0.0.0"></td></tr>
                        </table>
        </td></tr>
