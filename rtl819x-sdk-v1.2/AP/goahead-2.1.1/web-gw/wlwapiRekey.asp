...
<form name=form1  method=POST action="/goform/formWapiReKey"> 
 ...
 key update.
   ...
   <table border=0 width=500>
	...
	<input type="hidden" name="REKEY_POLICY" value=<%write(getIndex("wapiUcastReKeyType"));%>>
	...
	<input type="hidden" name="REKEY_M_POLICY" value=<%write(getIndex("wapiMcastReKeyType"));%>>
	...
	<input type="hidden" name="next_webpage" value="/wlwapiRekey.asp">
</form> 
