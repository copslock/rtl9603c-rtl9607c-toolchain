...
<body>
<blockquote>
<h2><font color="#0000FF">Active Wireless Client Table <% if (getIndex("wlan_num") > 1) write("-wlan"+(getIndex("wlan_idx")+1)); %></font></h2>
...
<tr bgcolor=#7f7f7f><td width="80"><font size=2><b>MAC Address</b></td>
<!--
