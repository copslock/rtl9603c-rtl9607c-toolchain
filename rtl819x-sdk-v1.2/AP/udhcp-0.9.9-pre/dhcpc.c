...
struct client_config_t client_config = {
	...
	url_name: NULL,
#endif	
#if defined(CONFIG_RTL8186_TR) || defined(CONFIG_RTL865X_KLD)	|| defined(CONFIG_RTL8196C_EC) || defined(CONFIG_RTL8196C_EC)
	wan_type:0,
	Inform:1,
	broadcast_flag:0,
#endif
...
#if defined(CONFIG_RTL8186_TR) || defined(CONFIG_RTL865X_KLD) || defined(CONFIG_RTL8196C_EC)
...
#endif
#if defined(CONFIG_RTL8186_TR) || defined(CONFIG_RTL865X_KLD) || defined(CONFIG_RTL865X_AC) || defined(CONFIG_RTL8196C_EC)
		...
		if (retval == 0) {
			...
			case INIT_SELECTING:
				...
				system("exlog /tmp/log_web.lck /tmp/log_web \"tag:SYSACT;log_num:13;msg:DHCP Discover;\"");
					...
					/* wait to try again */
					packet_num = 0;
					/* make more constructive to send dhcp discover 2010-0305*/
					timeout = now + 10;
...
#if defined(CONFIG_RTL8186_TR) || defined(CONFIG_RTL865X_AC) || defined(CONFIG_RTL8196C_EC)
